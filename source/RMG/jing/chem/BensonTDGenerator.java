...
public class BensonTDGenerator extends TDGenerator {
    ...
    /**
     * Generates a thermochemistry object based solely on Benson Group additivity.<BR>
     * <BR>
     * In case an adequate ring correction, or polycyclic ring correction is not found. This will return the
     * thermochemistry object WITHOUT corrections but will warn the user for this.
     */
    @Override
...
// six-membered ring.
        if (chemGraph.fromprimarythermolibrary) {
            // No action is needed because the thermo comes from a library
                ...
                && monoCyclicRSCs.isImperfectMatch()) {
