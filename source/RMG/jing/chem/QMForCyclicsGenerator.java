...
public class QMForCyclicsGenerator extends TDGenerator {
    ...
    /**
     * Generates thermochemistry for acyclic species based on Benson. Tries to estimate thermo for cyclic species based
     * on the QM methods. If multiple QM attempts fail, fall back to the Benson approach.
     */
    @Override
