...
public class Mol2AdjList {
	...
	public static void main(String[] args) {
		...
		try {
	        ...
	        fw.close();
	        System.out.println("Program complete.  File chemgraphs_output.txt written successfully.");
		} catch (IOException e) {
			System.out.println("Error writing chemgraphs_output.txt file: " + e.toString());
			System.exit(0);
		}
