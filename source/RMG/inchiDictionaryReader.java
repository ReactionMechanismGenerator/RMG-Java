...
public class inchiDictionaryReader {
    public static void main(String[] args) {
        ...
        // gmagoon 2/19/10: created inchiDictionaryReader from old commented out code and existing code in
// DictionaryReader; inchiDictionaryReader should be used with extreme caution for biradicals and higher (see comment in
// DictionaryReader.java)
        ...
        try {
            ...
            fw.close();
            System.out
                    .println("Program complete.  File inchiDictionaryAdjList.txt written successfully.");
        } catch (IOException e) {
            System.out
                    .println("Error writing inchiDictionaryAdjList.txt file: "
                            + e.toString());
            System.exit(0);
        }
