...
echo Compiling fame...
cd "%rmg%"\source\fame
g95 -O3 math.f90 states.f90 _modes.f90 network.f90 io.f90 mastereqn.f90 msc.f90 rs.f90 model.f90 fame.f90 blas\*.f lapack\double\*.f lapack\util\*.f -o "%rmg%"\bin\fame.exe
